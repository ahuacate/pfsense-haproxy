...
- [7.00 Create some Firewall Rules](#700-create-some-firewall-rules)
	- [7.01 Edit your UniFi network firewall](#701-edit-your-unifi-network-firewall)
	- [7.02 HAProxy Allow Rule on WAN - HAProxy](#702-haproxy-allow-rule-on-wan---haproxy)
